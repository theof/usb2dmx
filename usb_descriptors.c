...
} ptl_config_descriptor_t;

ptl_config_descriptor_t config_descriptor = {
    .config = {
        .bLength = sizeof(tusb_desc_configuration_t),
        .bDescriptorType = TUSB_DESC_CONFIGURATION,
        .wTotalLength = sizeof(ptl_config_descriptor_t),
        .bNumInterfaces = 1,
    ...
    .bulk_out = {
        ...
        .wMaxPacketSize = CFG_PTL_BULK_OUT_SIZE,
    },
};
...
static ptl_desc_string_t string_descriptor = {
